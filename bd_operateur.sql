...
INSERT INTO `permissions` (`id`, `nom`, `ressource`, `action`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'operateur:create', 'operateur', 'create', 'Créer un nouvel opérateur', NULL, NULL),
	(2, 'operateur:read', 'operateur', 'read', 'Consulter la liste et les détails des opérateurs', NULL, NULL),
	(3, 'operateur:update', 'operateur', 'update', 'Modifier les informations d\'un opérateur', NULL, NULL),
	(4, 'operateur:delete', 'operateur', 'delete', 'Supprimer un opérateur', NULL, NULL),
	(5, 'operateur:validate', 'operateur', 'validate', 'Valider un opérateur (formalisation)', NULL, NULL),
	(6, 'taxe:create', 'taxe', 'create', 'Créer une nouvelle taxe', NULL, NULL),
	(7, 'taxe:read', 'taxe', 'read', 'Consulter la liste des taxes', NULL, NULL),
	(8, 'taxe:update', 'taxe', 'update', 'Modifier une taxe', NULL, NULL),
	(9, 'taxe:delete', 'taxe', 'delete', 'Supprimer une taxe', NULL, NULL),
	(10, 'paiement:create', 'paiement', 'create', 'Créer une déclaration de paiement', NULL, NULL),
	(11, 'paiement:read', 'paiement', 'read', 'Consulter les paiements', NULL, NULL),
	(12, 'paiement:validate', 'paiement', 'validate', 'Valider un paiement', NULL, NULL),
	(13, 'paiement:delete', 'paiement', 'delete', 'Supprimer un paiement', NULL, NULL),
	(14, 'facture:create', 'facture', 'create', 'Générer une facture', NULL, NULL),
	(15, 'facture:read', 'facture', 'read', 'Consulter les factures', NULL, NULL),
	(16, 'facture:update', 'facture', 'update', 'Modifier une facture', NULL, NULL),
	(17, 'facture:delete', 'facture', 'delete', 'Supprimer une facture', NULL, NULL),
	(18, 'permis:create', 'permis', 'create', 'Délivrer un permis', NULL, NULL),
	(19, 'permis:read', 'permis', 'read', 'Consulter les permis', NULL, NULL),
	(20, 'permis:update', 'permis', 'update', 'Modifier un permis', NULL, NULL),
	(21, 'permis:delete', 'permis', 'delete', 'Supprimer un permis', NULL, NULL),
	(22, 'utilisateur:create', 'utilisateur', 'create', 'Créer un utilisateur', NULL, NULL),
	(23, 'utilisateur:read', 'utilisateur', 'read', 'Consulter les utilisateurs', NULL, NULL),
	(24, 'utilisateur:update', 'utilisateur', 'update', 'Modifier un utilisateur', NULL, NULL),
	(25, 'utilisateur:delete', 'utilisateur', 'delete', 'Supprimer un utilisateur', NULL, NULL),
	(26, 'statistique:read', 'statistique', 'read', 'Consulter les statistiques et rapports', NULL, NULL),
	(27, 'audit:read', 'audit', 'read', 'Consulter les logs et historiques', NULL, NULL),
	(65, 'dashboard:read', 'dashboard', 'read', 'Consulter le tableau de bord', NULL, NULL);
...
-- Listage des données de la table bd_operateur.provinces : ~0 rows (environ)
...
INSERT INTO `roles_permissions` (`role_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(1, 1, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 2, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 3, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 4, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 5, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 6, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 7, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 8, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 9, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 10, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 11, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 12, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 13, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 14, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 15, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 16, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 17, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 18, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 19, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 20, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 21, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 22, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 23, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 24, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 25, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 26, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(1, 27, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(2, 6, '2026-09-03 15:30:17', '2026-09-03 15:30:17'),
	(2, 7, '2026-09-03 15:30:17', '2026-09-03 15:30:17'),
	(2, 8, '2026-09-03 15:30:17', '2026-09-03 15:30:17'),
	(2, 9, '2026-09-03 15:30:17', '2026-09-03 15:30:17'),
	(2, 14, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(2, 15, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(2, 16, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(2, 17, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(2, 27, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(2, 65, '2026-09-03 15:29:40', '2026-09-03 15:29:40'),
	(3, 1, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(3, 2, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(3, 3, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(4, 2, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(4, 10, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(4, 11, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	...
	(6, 15, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(6, 26, '2026-09-02 18:35:16', '2026-09-02 18:35:16'),
	(6, 27, '2026-09-02 18:35:16', '2026-09-02 18:35:16');
...
-- Listage des données de la table bd_operateur.villes : ~0 rows (environ)
