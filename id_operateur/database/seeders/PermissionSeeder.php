...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['nom' => 'paiement:read', 'ressource' => 'paiement', 'action' => 'read', 'description' => 'Consulter les déclarations'],
            ['nom' => 'paiement:update', 'ressource' => 'paiement', 'action' => 'update', 'description' => 'Modifier une déclaration de paiement'],
            ['nom' => 'paiement:validate', 'ressource' => 'paiement', 'action' => 'validate', 'description' => 'Valider une déclaration'],
            ['nom' => 'paiement:delete', 'ressource' => 'paiement', 'action' => 'delete', 'description' => 'Supprimer une déclaration'],
